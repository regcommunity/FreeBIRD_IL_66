...
class F_14_00_REF_FINREP_3_0_UnionTable :
	...
	F_14_00_REF_FINREP_3_0_Equity_instruments_security_Table = None # Equity_instruments_security
	F_14_00_REF_FINREP_3_0_Equity_instruments_instrument_Table = None # Equity_instruments_instrument
	...
	F_14_00_REF_FINREP_3_0_Advances_that_are_not_loans_Table = None # Advances_that_are_not_loans
	F_14_00_REF_FINREP_3_0_Other_loans_Table = None # Other_loans
	F_14_00_REF_FINREP_3_0_Credit_card_debt_Table = None # Credit_card_debt
	F_14_00_REF_FINREP_3_0_Trade_receivables_Table = None # Trade_receivables
	F_14_00_REF_FINREP_3_0_Finance_leases_Table = None # Finance_leases
	F_14_00_REF_FINREP_3_0_On_demand_and_short_notice_Table = None # On_demand_and_short_notice
	F_14_00_REF_FINREP_3_0_Reverse_repurchase_agreements_Table = None # Reverse_repurchase_agreements
	...
	def calc_F_14_00_REF_FINREP_3_0_UnionItems(self) -> list[F_14_00_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_14_00_REF_FINREP_3_0_Equity_instruments_security_Table.Equity_instruments_securitys:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Equity_instruments_instrument_Table.Equity_instruments_instruments:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		...
		for item in self.F_14_00_REF_FINREP_3_0_Other_financial_liabilities_Table.Other_financial_liabilitiess:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Advances_that_are_not_loans_Table.Advances_that_are_not_loanss:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Other_loans_Table.Other_loanss:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Credit_card_debt_Table.Credit_card_debts:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Trade_receivables_Table.Trade_receivabless:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Finance_leases_Table.Finance_leasess:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_On_demand_and_short_notice_Table.On_demand_and_short_notices:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_14_00_REF_FINREP_3_0_Reverse_repurchase_agreements_Table.Reverse_repurchase_agreementss:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
...
class Equity_instruments_security(F_14_00_REF_FINREP_3_0_Base):
...
class Equity_instruments_instrument(F_14_00_REF_FINREP_3_0_Base):
...
class Derivatives_ETC(F_14_00_REF_FINREP_3_0_Base):
	...
	@lineage(dependencies={"EXCHNG_TRDBL_DRVTV_PSTN_RL.FV_HRRCHY"})
	def FV_HRRCHY(self):
		return self.EXCHNG_TRDBL_DRVTV_PSTN_RL.FV_HRRCHY
	@lineage(dependencies={"EXCHNG_TRDBL_DRVTV_PSTN_RL.FV"})
	def FV(self):
		return self.EXCHNG_TRDBL_DRVTV_PSTN_RL.FV
	@lineage(dependencies={"EXCHNG_TRDBL_DRVTV_PSTN_RL.FV_CHNG"})
	def FV_CHNG(self):
		return self.EXCHNG_TRDBL_DRVTV_PSTN_RL.FV_CHNG
...
class Advances_that_are_not_loans(F_14_00_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Credit_card_debt(F_14_00_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Trade_receivables(F_14_00_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Finance_leases(F_14_00_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class On_demand_and_short_notice(F_14_00_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Reverse_repurchase_agreements(F_14_00_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class F_14_00_REF_FINREP_3_0_Equity_instruments_security_Table:
...
class F_14_00_REF_FINREP_3_0_Equity_instruments_instrument_Table:
...
class F_14_00_REF_FINREP_3_0_Advances_that_are_not_loans_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
...
class F_14_00_REF_FINREP_3_0_Credit_card_debt_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
...
class F_14_00_REF_FINREP_3_0_Trade_receivables_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
...
class F_14_00_REF_FINREP_3_0_Finance_leases_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
...
class F_14_00_REF_FINREP_3_0_On_demand_and_short_notice_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
...
class F_14_00_REF_FINREP_3_0_Reverse_repurchase_agreements_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL

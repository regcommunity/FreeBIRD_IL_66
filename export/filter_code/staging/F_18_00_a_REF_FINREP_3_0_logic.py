...
class F_18_00_a_REF_FINREP_3_0_UnionTable :
	...
	F_18_00_a_REF_FINREP_3_0_Advances_that_are_not_loans_Table = None # Advances_that_are_not_loans
	F_18_00_a_REF_FINREP_3_0_Other_loans_Table = None # Other_loans
	F_18_00_a_REF_FINREP_3_0_Credit_card_debt_Table = None # Credit_card_debt
	F_18_00_a_REF_FINREP_3_0_Trade_receivables_Table = None # Trade_receivables
	F_18_00_a_REF_FINREP_3_0_Finance_leases_Table = None # Finance_leases
	F_18_00_a_REF_FINREP_3_0_On_demand_and_short_notice_Table = None # On_demand_and_short_notice
	F_18_00_a_REF_FINREP_3_0_Reverse_repurchase_agreements_Table = None # Reverse_repurchase_agreements
	...
	def calc_F_18_00_a_REF_FINREP_3_0_UnionItems(self) -> list[F_18_00_a_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_18_00_a_REF_FINREP_3_0_Advances_that_are_not_loans_Table.Advances_that_are_not_loanss:
		...
		for item in self.F_18_00_a_REF_FINREP_3_0_Other_loans_Table.Other_loanss:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_a_REF_FINREP_3_0_Credit_card_debt_Table.Credit_card_debts:
			newItem = F_18_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_a_REF_FINREP_3_0_Trade_receivables_Table.Trade_receivabless:
			newItem = F_18_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_a_REF_FINREP_3_0_Finance_leases_Table.Finance_leasess:
			newItem = F_18_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_a_REF_FINREP_3_0_On_demand_and_short_notice_Table.On_demand_and_short_notices:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_18_00_a_REF_FINREP_3_0_Reverse_repurchase_agreements_Table.Reverse_repurchase_agreementss:
			newItem = F_18_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
...
class Advances_that_are_not_loans(F_18_00_a_REF_FINREP_3_0_Base):
...
class Credit_card_debt(F_18_00_a_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Trade_receivables(F_18_00_a_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Finance_leases(F_18_00_a_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class Reverse_repurchase_agreements(F_18_00_a_REF_FINREP_3_0_Base):
	INSTRMNT = None # INSTRMNT
	@lineage(dependencies={"INSTRMNT.INSTRMNT_TYP_PRDCT"})
	def INSTRMNT_TYP_PRDCT(self):
		return self.INSTRMNT.INSTRMNT_TYP_PRDCT
...
class F_18_00_a_REF_FINREP_3_0_Advances_that_are_not_loans_Table:
...
class F_18_00_a_REF_FINREP_3_0_Credit_card_debt_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
	PRTY_Table = None # PRTY
	INSTRMNT_ENTTY_RL_ASSGNMNT_Table = None # INSTRMNT_ENTTY_RL_ASSGNMNT
...
class F_18_00_a_REF_FINREP_3_0_Trade_receivables_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
	PRTY_Table = None # PRTY
	INSTRMNT_ENTTY_RL_ASSGNMNT_Table = None # INSTRMNT_ENTTY_RL_ASSGNMNT
...
class F_18_00_a_REF_FINREP_3_0_Finance_leases_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
	PRTY_Table = None # PRTY
	INSTRMNT_ENTTY_RL_ASSGNMNT_Table = None # INSTRMNT_ENTTY_RL_ASSGNMNT
...
class F_18_00_a_REF_FINREP_3_0_Reverse_repurchase_agreements_Table:
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
	PRTY_Table = None # PRTY
	INSTRMNT_ENTTY_RL_ASSGNMNT_Table = None # INSTRMNT_ENTTY_RL_ASSGNMNT

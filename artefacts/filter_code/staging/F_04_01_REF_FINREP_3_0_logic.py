...
class F_04_01_REF_FINREP_3_0_UnionTable :
	...
	F_04_01_REF_FINREP_3_0_Equity_instruments_security_Table = None # Equity_instruments_security
	F_04_01_REF_FINREP_3_0_Equity_instruments_instrument_Table = None # Equity_instruments_instrument
	F_04_01_REF_FINREP_3_0_Advances_that_are_not_loans_Table = None # Advances_that_are_not_loans
	F_04_01_REF_FINREP_3_0_Other_loans_Table = None # Other_loans
	F_04_01_REF_FINREP_3_0_Credit_card_debt_Table = None # Credit_card_debt
	F_04_01_REF_FINREP_3_0_Trade_receivables_Table = None # Trade_receivables
	F_04_01_REF_FINREP_3_0_Finance_leases_Table = None # Finance_leases
	F_04_01_REF_FINREP_3_0_On_demand_and_short_notice_Table = None # On_demand_and_short_notice
	F_04_01_REF_FINREP_3_0_Reverse_repurchase_agreements_Table = None # Reverse_repurchase_agreements
	...
	def calc_F_04_01_REF_FINREP_3_0_UnionItems(self) -> list[F_04_01_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_04_01_REF_FINREP_3_0_Equity_instruments_security_Table.Equity_instruments_securitys:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Equity_instruments_instrument_Table.Equity_instruments_instruments:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Advances_that_are_not_loans_Table.Advances_that_are_not_loanss:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Other_loans_Table.Other_loanss:
			...
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Credit_card_debt_Table.Credit_card_debts:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Trade_receivables_Table.Trade_receivabless:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Finance_leases_Table.Finance_leasess:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_On_demand_and_short_notice_Table.On_demand_and_short_notices:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_04_01_REF_FINREP_3_0_Reverse_repurchase_agreements_Table.Reverse_repurchase_agreementss:
			newItem = F_04_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
